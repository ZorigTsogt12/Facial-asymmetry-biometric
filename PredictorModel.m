...
%Uses the trained model to predict the inputs

ds = datastore("*.csv"); 
vars = ds.VariableNames;
idx = startsWith(vars, ["confidence", "x_", "y_"]);
ds.SelectedVariableNames = vars(idx);

old = "C:\Users\Zorig\Documents\Third Year\Project\OpenFace\processed\TestClasses2\";
...
%%
SymmetryPred = table(Names, Ratioouteye, Ratioineye, Rationose2jaw, Rationostril, Ratiomouth, Ratiojaw2mouth, Ratiomid2edge, Ratiomouth2edge, mouthAR, jawAR, eyeAR, eyetiltAR, nosetiltAR, browtiltAR);
[prediction, posterior] = trainedModel.predictFcn(SymmetryPred);
